...
public class AssignRoleCommandHandler : IRequestHandler<AssignRoleCommand, UsersModel>
{
    ...
    public async Task<UsersModel> Handle(AssignRoleCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            throw new UserException(400, "Role already added to this user");
        }
